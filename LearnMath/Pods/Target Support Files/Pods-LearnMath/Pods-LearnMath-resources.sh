...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AppToolKit/AppToolKit.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/AppearanceKit/AppearanceKit.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/ArithmeticKit/ArithmeticKit.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/EZPlayer/EZPlayer.bundle"
