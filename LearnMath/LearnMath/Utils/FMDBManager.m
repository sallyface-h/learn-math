...
- (void)creatTableWithName:(NSString *)tableName andMembers:(NSDictionary<NSString *,NSString *> *)members andPrimaryKey:(NSString *)primaryKey
{
...
- (BOOL)insertIntoTable:(NSString *)tableName members:(NSArray<NSDictionary<NSString *, id> *> *)members
{
    ...
    for (NSDictionary *dict in members) {
        ...
        NSString *sql = [NSString stringWithFormat:@"INSERT INTO %@ (%@) VALUES (%@)",tableName,[columns componentsJoinedByString:@", "],[placeHolders componentsJoinedByString:@", "]];
