//
//  MathAnswerSheetQuestionAddMovingTheNumbers.m
//  LearnMath
//
...
@interface MathAnswerSheetQuestionAddMovingTheNumbers ()
...
@end
@implementation MathAnswerSheetQuestionAddMovingTheNumbers
...
- (void)check:(MathAnswerSheetTextField *)firstResponder
{
    ...
    NSArray *fields = @[self.aTextField, self.bTextField, self.cTextField, self.dTextField];
...
- (void)setupSubviews
{
    ...
    self.stackView.spacing = LearnMathScale(0.0);
...
- (void)drawLines
{
    ...
    [firstPath moveToPoint:CGPointMake(CGRectGetMinX(self.aTextField.frame), CGRectGetMaxY(self.aNumberLabel.frame) + LearnMathScale(9.0))];
    [firstPath addLineToPoint:CGPointMake(CGRectGetMaxX(self.cTextField.frame), CGRectGetMinY(self.cTextField.frame) - LearnMathScale(9.0))];
    addLine(firstPath);
    
    UIBezierPath *secondPath = [UIBezierPath bezierPath];
    [secondPath moveToPoint:CGPointMake(CGRectGetMaxX(self.dTextField.frame) + LearnMathScale(9.0), CGRectGetMidY(self.dTextField.frame))];
    [secondPath addLineToPoint:CGPointMake(self.aTextField.center.x, CGRectGetMidY(self.dTextField.frame))];
    [secondPath addLineToPoint:CGPointMake(self.aTextField.center.x, CGRectGetMaxY(self.aTextField.frame) + LearnMathScale(9.0))];
    addLine(secondPath);
    
    UIBezierPath *thirdPath = [UIBezierPath bezierPath];
    [thirdPath moveToPoint:CGPointMake(CGRectGetMidX(self.bTextField.frame), CGRectGetMaxY(self.bTextField.frame) + LearnMathScale(9.0))];
    [thirdPath addLineToPoint:CGPointMake(CGRectGetMidX(self.dTextField.frame) + LearnMathScale(9.0), CGRectGetMinY(self.dTextField.frame) - LearnMathScale(9.0))];
    addLine(thirdPath);
    
    UIBezierPath *fourthPath = [UIBezierPath bezierPath];
    [fourthPath moveToPoint:CGPointMake(CGRectGetMidX(self.a1NumberLabel.frame), CGRectGetMaxY(self.bTextField.frame) + LearnMathScale(9.0))];
    [fourthPath addLineToPoint:CGPointMake(CGRectGetMidX(self.dTextField.frame) - LearnMathScale(9.0), CGRectGetMinY(self.dTextField.frame) - LearnMathScale(9.0))];
    addLine(fourthPath);
}
@end
