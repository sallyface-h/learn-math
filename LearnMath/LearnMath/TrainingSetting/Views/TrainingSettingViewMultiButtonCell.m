...
- (void)setUpSubviews{
    ...
    TrainingSettingModels *model = [TrainingSettingModels trainingSettingModelMake];
    for (NSInteger i = 0; i < model.calculateNum.count; i++) {
       UIButton *settingNumButton = [UIButton buttonWithType:UIButtonTypeCustom];
        ...
        label.text = model.calculateNum[i];
