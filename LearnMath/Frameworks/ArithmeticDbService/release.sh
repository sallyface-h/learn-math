...
podName="ArithmeticDbService"
homepage="https://github.com/vjieshao/Arithmetic_iOS.git"
httpsRepo="https://github.com/vjieshao/Arithmetic_iOS.git"
podspecFilePath="./ArithmeticDbService.podspec"
