...
open class EZPlayerControlView: UIView{
    ...
    @IBOutlet weak var playPauseButtonLeadingConstraint: NSLayoutConstraint!
    @IBOutlet weak var fullEmbeddedScreenButtonTrailingConstraint: NSLayoutConstraint!
    ...
    open override func layoutSubviews() {
        ...
        topGradientLayer.locations = [0.0, 0.2, 0.8, 1.0]
        topGradientLayer.frame = self.bounds
        self.backgroundView.layer.mask = topGradientLayer
    }
    ...
    override open func awakeFromNib() {
        super.awakeFromNib()
        self.timeSlider.setThumbImage(UIImage(named: "slider_thum", in: Configurations.bundle, with: nil), for: .normal)
        self.timeSlider.setThumbImage(UIImage(named: "slider_thum", in: Configurations.bundle, with: nil), for: .highlighted)
        self.timeSlider.value = 0
        
        for imgView in self.progressView.subviews {
        ...
        if UIDevice.current.orientation == .landscapeLeft || UIDevice.current.orientation == .landscapeRight {
            ...
            fullEmbeddedScreenButtonWidthConstraint.constant = 0.0
        }


        let airplayImage = UIImage(named: "btn_airplay", in: Configurations.bundle,compatibleWith: nil)
    ...
    func checkOrientation(_ orientation: UIDeviceOrientation) {
        if orientation.isLandscape {
            ...
            playPauseButtonLeadingConstraint.constant = 80.0
            fullEmbeddedScreenButtonTrailingConstraint.constant = 80.0
            
            stackViewLeadingConstraint.constant = 22.0
            stackViewTrailingConstraint.constant = 22.0
            
            timeLabel.isHidden = false
        } else {
            self.isPortrait = false
            playPauseButtonLeadingConstraint.constant = 14.0
            fullEmbeddedScreenButtonTrailingConstraint.constant = 14.0
            
            stackViewLeadingConstraint.constant = 0.0
            stackViewTrailingConstraint.constant = 0.0
    ...
    fileprivate func autohideControlView(){
        ...
        self.hideControlViewTask = delay(10, task: { [weak self]  in
...
extension EZPlayerControlView: EZPlayerCustom {
    ...
    @IBAction public func fullEmbeddedScreenButtonPressed(_ sender: Any) {
        ...
        case .embedded:
            player.toFull()
            checkOrientation(.landscapeLeft)
        case .fullscreen:
    ...
    @IBAction public func audioSubtitleCCButtonPressed(_ sender: Any) {
        ...
        let audibleLegibleViewController = EZPlayerAudibleLegibleViewController(nibName:  String(describing: EZPlayerAudibleLegibleViewController.self),bundle: Configurations.bundle,player:player, sourceView:sender as? UIView)
...
//        self.showThumbnail()
    ...
    public func player(_ player: EZPlayer, playerDisplayModeDidChange displayMode: EZPlayerDisplayMode) {
        ...
        case .none:
            break
        case .embedded:
            self.fullEmbeddedScreenButtonWidthConstraint.constant = 48.0
            self.fullEmbeddedScreenButton.setImage(UIImage(named: "btn_fullscreen22x22", in: Configurations.bundle, compatibleWith: nil), for: .normal)
            self.pipButtonWidthConstraint.constant = (player.scrollView != nil || player.floatMode == .none ) ? 0 : 50
        case .fullscreen:
            self.fullEmbeddedScreenButtonWidthConstraint.constant = 48.0
            self.fullEmbeddedScreenButton.setImage(UIImage(named: "btn_normalscreen22x22", in: Configurations.bundle, compatibleWith: nil), for: .normal)
    ...
    public func player(_ player: EZPlayer, playerStateDidChange state: EZPlayerState) {
        ...
        case .playing ,.buffering:
            ...
            self.playPauseButton.setImage(UIImage(named: "btn_pause22x22", in: Configurations.bundle, compatibleWith: nil), for: .normal)

        case .seekingBackward ,.seekingForward:
            break
        default:
            //            self.playPauseButton.isSelected = false // 播放按钮
            self.playPauseButton.setImage(UIImage(named: "btn_play22x22", in: Configurations.bundle, compatibleWith: nil), for: .normal)
