...
public extension ProgressHUD {
    ...
    class func info(_ text: String? = nil, interaction: Bool = true, delay: TimeInterval? = nil) {
        DispatchQueue.main.async {
            shared.staticImage(text: text, image: nil, isInfo: true, interaction: interaction, delay: delay)
        }
    }
}
...
public extension ProgressHUD {
	...
	class func image(_ text: String? = nil, image: UIImage?, interaction: Bool = true, delay: TimeInterval? = nil) {
		DispatchQueue.main.async {
            shared.staticImage(text: text, image: image, isInfo: false, interaction: interaction, delay: delay)
		}
	}
	...
	class func symbol(_ text: String? = nil, name: String, interaction: Bool = true, delay: TimeInterval? = nil) {
		DispatchQueue.main.async {
			...
			shared.staticImage(text: text, image: colored, isInfo: false, interaction: interaction, delay: delay)
		}
	}

	class func success(_ text: String? = nil, image: UIImage? = nil, interaction: Bool = true, delay: TimeInterval? = nil) {
		DispatchQueue.main.async {
			shared.staticImage(text: text, image: image ?? imageSuccess, isInfo: false, interaction: interaction, delay: delay)
		}
	}

	class func error(_ text: String? = nil, image: UIImage? = nil, interaction: Bool = true, delay: TimeInterval? = nil) {
		DispatchQueue.main.async {
			shared.staticImage(text: text, image: image ?? imageError, isInfo: false, interaction: interaction, delay: delay)
		}
	}

	class func error(_ error: Error?, image: UIImage? = nil, interaction: Bool = true, delay: TimeInterval? = nil) {
		DispatchQueue.main.async {
			shared.staticImage(text: error?.localizedDescription, image: image ?? imageError, isInfo: false, interaction: interaction, delay: delay)
		}
	}
}
