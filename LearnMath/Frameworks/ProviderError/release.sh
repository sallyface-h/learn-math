...
podName="ProviderError"
homepage="https://github.com/Nuevo-Mundo/Emperor_iOS.git"
httpsRepo="https://github.com/Nuevo-Mundo/Emperor_iOS.git"
podspecFilePath="./ProviderError.podspec"
